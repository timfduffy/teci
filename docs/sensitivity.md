...
improves than the <=2B tier (baseline **1.21**). A variant that barely
...
|---|---:|---:|---:|---|---:|---:|
| `gemma-arcc-split` | 5 | 0.06 | 1.39 | Gemma 2B IT [Instruction-tuned (IT)] (-1.4) | 1.12 | -0.09 |
| `gemma-gsm8k-split` | 5 | 0.12 | 1.26 | Gemma 7B IT [Instruction-tuned (IT)] (+1.3) | 1.33 | +0.12 |
| `livebench-split` | 14 | 0.08 | 1.11 | Qwen3-0.6B [Non-thinking mode] (-1.1) | 1.37 | +0.16 |
| `qwen-gsm8k-split` | 3 | 0.04 | 0.99 | Qwen-1.8B-Chat [Instruct/chat] (-1.0) | 1.20 | -0.01 |
| `gemma-winogrande-split` | 8 | 0.05 | 0.54 | Gemma 1.1 7B IT [Instruction-tuned (IT)] (-0.5) | 1.25 | +0.04 |
| `ifeval-split` | 7 | 0.04 | 0.52 | Qwen3.5-0.8B [Non-thinking rows] (-0.5) | 1.23 | +0.02 |
| `arenahard-split` | 14 | 0.10 | 0.45 | Qwen2.5-32B-Instruct [Instruct/chat] (+0.4) | 1.18 | -0.03 |
| `qwen-mmlu-split` | 3 | 0.02 | 0.37 | Qwen-14B-Chat [Instruct/chat] (-0.4) | 1.25 | +0.04 |
| `hmmt-split` | 4 | 0.01 | 0.26 | Qwen3-30B-A3B-Thinking-2507 [Thinking] (+0.3) | 1.23 | +0.02 |
| `gpqa-split` | 7 | 0.05 | 0.24 | Qwen2-7B-Instruct [Instruct/chat] (+0.2) | 1.21 | +0.00 |
| `lcb-v6-merge` | 7 | 0.02 | 0.22 | Qwen3.8-27B [Thinking (default)] (+0.2) | 1.21 | -0.00 |
| `gemma-hellaswag-split` | 5 | 0.01 | 0.19 | Gemma 2B [Pretrained (PT)] (+0.2) | 1.21 | -0.00 |
...
Fitted at 114.2 and 114.8 TECI (+0.5).
