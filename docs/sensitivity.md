...
improves than the <=2B tier (baseline **3.30**). A variant that barely
...
|---|---:|---:|---:|---|---:|---:|
| `gemma-arcc-split` | 5 | 0.05 | 1.35 | Gemma 2B IT [Instruction-tuned (IT)] (-1.3) | 3.17 | -0.12 |
| `gemma-gsm8k-split` | 5 | 0.08 | 1.30 | Gemma 2B IT [Instruction-tuned (IT)] (+1.3) | 3.40 | +0.11 |
| `livebench-split` | 14 | 0.11 | 1.13 | Qwen3-0.6B [Non-thinking mode] (-1.1) | 3.44 | +0.14 |
| `qwen-gsm8k-split` | 3 | 0.05 | 1.06 | Qwen-1.8B-Chat [Instruct/chat] (-1.1) | 3.26 | -0.03 |
| `gemma-winogrande-split` | 8 | 0.05 | 0.54 | Gemma 1.1 7B IT [Instruction-tuned (IT)] (-0.5) | 3.36 | +0.06 |
| `hmmt-split` | 4 | 0.07 | 0.54 | Qwen3.5-2B [Thinking (default)] (-0.5) | 3.37 | +0.07 |
| `arenahard-split` | 14 | 0.07 | 0.38 | Qwen2.5-32B-Instruct [Instruct/chat] (+0.4) | 3.27 | -0.03 |
| `qwen-mmlu-split` | 3 | 0.02 | 0.37 | Qwen-14B-Chat [Instruct/chat] (-0.4) | 3.35 | +0.06 |
| `gpqa-split` | 7 | 0.06 | 0.26 | Qwen2-7B-Instruct [Instruct/chat] (+0.3) | 3.29 | -0.01 |
| `lcb-v6-merge` | 6 | 0.02 | 0.25 | Qwen3.5-4B [Thinking (default)] (-0.3) | 3.31 | +0.01 |
| `gemma-hellaswag-split` | 5 | 0.01 | 0.19 | Gemma 2B [Pretrained (PT)] (+0.2) | 3.30 | +0.00 |
